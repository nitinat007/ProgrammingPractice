 ...
 *
 * Approach: set by step below. arr given and k=7
 * arr =     {3, 5, 1, -8, 2, 4, 11, 3, 7, 14}
 * rem =     {3, 5, 1, -1, 2, 4, 4, 3, 0, 0}     // k-arr[i]
 * compRem = {4, 2, 6, 1, 5, 3, 3, 4, 0, 0}      //k-rem[i]
 * put compRem values and its frequency in a hashMap. So, we obtain below hashmap entry
 * 4->2 , 2->1 , 6->1 , 1->1 , 5->1 , 3->2 , 0->2
